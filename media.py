...
class Track(Media):
    ...
    def __init__(self, title="No Title", artist="No Artist", releaseDate="No Release Date", url="No URL", album="No Album", genre="No Genre", duration=0) -> None:
        """
    ...
    def length(self) -> int:
        ...
        """
        return self.duration // 1000 # convert from milliseconds to seconds
...
class Movie(Media):
    ...
    def __init__(self, title="No Title", artist="No Artist", releaseDate="No Release Date", url="No URL", rating="No Rating", movieLength=0) -> None:
        """
    ...
    def length(self) -> int:
        ...
        """
        return self.movieLength // 60000 # converts from milliseconds to minutes
